...
import blog.service.AuthorDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityConfig(AuthorDetailsService authorDetailsService, JwtAuthenticationFilter jwtAuthenticationFilter) {
